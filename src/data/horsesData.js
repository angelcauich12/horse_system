...
import orion1 from '../assets/images/orion/orion_1.jpeg';
import orion2 from '../assets/images/orion/orion_2.jpeg';
import orion3 from '../assets/images/orion/orion_3.jpeg';
import orion4 from '../assets/images/orion/orion_4.jpeg';

const horsesData = [
  {
    id: 1,
    name: "ORION LA HACIENDA",
    ...
    description: "Orion La Hacienda es un ejemplar joven con excelente proyección deportiva dentro del salto ecuestre. Destaca por su estructura atlética, equilibrio natural y una genética cuidadosamente seleccionada que combina potencia, técnica y mentalidad competitiva. Su línea sanguínea lo posiciona como una opción ideal tanto para desarrollo deportivo como para inversión, ofreciendo cualidades de rideability, inteligencia y capacidad de salto.",
    pedigree: {
      sections: [
        {
          title: "Sire Line",
    ...
    subtitle: "Young Showjumping Prospect",
    color: "Bay",
    height: "16.1 manos",
